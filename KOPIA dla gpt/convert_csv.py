...
df = pd.read_csv('Copper Futures Historical Data(1).csv')
...
output.to_csv('miedz_import_clean.csv', index=False)

print(f"Przekonwertowano {len(output)} wierszy")
print("Plik miedz_import_clean.csv gotowy do importu do Supabase!")
print("\nPierwsze 5 wierszy:")
print(output.head())